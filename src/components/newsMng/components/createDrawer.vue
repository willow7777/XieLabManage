<template>
    <Drawer title="添加新闻" v-model="value" width="500" :mask-closable="false" :styles="styles">
...
export default {
    ...
    methods: {
        ...
        adduser () {
            ...
            this.axios.post('/api/news/addNews', JSON.stringify(this.formData), {
        ...
        updateuser () {
            ...
            delete form._index
            delete form._rowKey
            this.axios.post('/api/news/updateNews', JSON.stringify(this.formData), {
              headers: {'Content-Type': 'application/json;charset=UTF-8'}
                }).then(result => {
              // res.data.data
